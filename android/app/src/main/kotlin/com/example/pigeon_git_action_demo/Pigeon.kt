...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): DeviceInfo {
      ...
      return DeviceInfo(model, osVersion, platform)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
interface DeviceApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: DeviceApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pigeon_git_action_demo.DeviceApi.getDeviceInfo$separatedMessageChannelSuffix", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pigeon_git_action_demo.DeviceApi.getBatteryInfo$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
